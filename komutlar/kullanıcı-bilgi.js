...
exports.run = async (bot, msg, args) => {
    ...
    if (kurulus > 1296000000) kontrol = 'Güvenilir'
      ...
      userinfo.status = user.presence.status.toString()
        .replace("dnd", `<a:anonim:724733826986803361> Rahatsız Etmeyin`)
        .replace("online", `<a:okk:724733881760350221> Çevrimiçi`)
        .replace("idle", `<a:can:724733888915701913> Boşta`)
        .replace("offline", `<a:sloading1:724733859534602350> Çevrimdışı`)  
